...
//  CatListView - класс хранит в себе все UI-элементы MVP-модуля "Список избранных котиков"
final class CatCollectionView: UIView {
    ...
    let placeholder: UIImageView = {
        ...
        placeholder.image = Image.emptyCollectionImage
    ...
    func placeholderConstraints() {
        NSLayoutConstraint.activate([
            ...
            placeholder.rightAnchor.constraint(equalTo: safeAreaLayoutGuide.rightAnchor),
            placeholder.bottomAnchor.constraint(equalTo: safeAreaLayoutGuide.bottomAnchor),
            placeholder.leftAnchor.constraint(equalTo: safeAreaLayoutGuide.leftAnchor)
        ])
    }
    ...
    private let titleLabel: UILabel = {
        ...
        titleLabel.text = "Ваши любимчики"
